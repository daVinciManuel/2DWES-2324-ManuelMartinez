...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    // esto es para testear la recogida de datos
    // echo '<p>'.$_POST['name'].'</p>'; 
    $f1=fopen("alumnos2.txt","a+");
    // Agrega salto de linea if file is not empty
    if(filesize("alumnos2.txt") > 1 ){
        fwrite($f1,"\n");
    }
    ...
    echo 'caracteres por linea: '.ftell($f1);
    echo 'numero de lineas: '. sizeof(file("alumnos2.txt"));
} 
?>
</body>
</html>